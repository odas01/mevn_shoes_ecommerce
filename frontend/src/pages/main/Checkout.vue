...
import thanksImage from "@/assets/image/checkout/thanks.jpg";
export default {
  components: {
    Row,
    Col,
  ...
  computed: {
    total() {
      ...
      if (this.infoOrder.discount && this.infoOrder.discount.includes("abc"))
        total -= 70000;
      return total;
    },
    totalAmount() {
  ...
  methods: {
    ...
    createOrderData(data) {
      ...
      return {
        ...
        discount: !!this.infoOrder.discount?.includes("abc") ? 70000 : 0,
        qty: details.length,
        total: this.total,
      };
    },
            ...
            <Col :xl="12" :xs="24">
              <div class="checkout__wrap">
                <div class="checkout__info">
                  <img
                    class="checkout__info-thumbnail"
                    :src="item.product.image"
                    alt=""
                  />
                  <span class="checkout__info-name">{{
                    item.product.name
                  }}</span>
